...
@resource_decorator("PearsonCorrelationResult", human_name="Result of pairwise spearman correlation coefficient analysis", hide=True)
...
class PearsonCorrelation(BasePairwiseStatsTask):
    ...
    * Config Parameters:
    ...
    output_specs = {'result': OutputSpec(PearsonCorrelationResult, human_name="Result", short_description="The output result")}
    config_specs = {
