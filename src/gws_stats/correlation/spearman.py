...
@resource_decorator("SpearmanCorrelationResult", human_name="Result of pairwise spearman correlation coefficient analysis", hide=True)
...
class SpearmanCorrelation(BasePairwiseStatsTask):
    ...
    * Config Parameters:
    ...
    output_specs = {'result': OutputSpec(SpearmanCorrelationResult, human_name="Result", short_description="The output result")}
    config_specs = {
